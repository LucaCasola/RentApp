import { StyleSheet, ActivityIndicator,	Pressable, Text, View, Button, TouchableOpacity } from "react-native";
...
export default function SearchMap({ navigation }) {
	...
	return (
		<>
			...
			<Pressable style={[styles.button, { position: 'absolute', top: 20, right: 20 }]} onPress={getMarkers}>
