...
const LoginScreen = ({ navigation }) => {
  // form fields
  const [emailFromUI, setEmailFromUI] = useState("lcasola@myseneca.ca"); //TODO: change this to an empty string when done testing
    ...
    if (auth.currentUser === null) {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          alert("Please login with an Valid-Owner credentials");
          await signOut(auth);
